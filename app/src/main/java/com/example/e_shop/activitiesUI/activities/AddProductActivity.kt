...
class AddProductActivity : BaseActivity(), View.OnClickListener{
    ...
    fun productUploadSuccess(){
        hideProgressDialog()
        Toast.makeText(this@AddProductActivity,resources.getString(R.string.product_uploaded_success_message),
    ...
    private fun uploadProductDetails() {
        ...
        val username =
            this.getSharedPreferences(Constants.ESHOP_PREFERENCE, Context.MODE_PRIVATE)
